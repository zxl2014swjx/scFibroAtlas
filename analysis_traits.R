...
gene_samples_df<-read.table("0.Data_preprocess/data_preprocessed.txt",header=T,sep="\t",row.names=1)
fibroblast_df<-read.table("1.Subtypes_deconvolution/deconvolution_scores.txt",
